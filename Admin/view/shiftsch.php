...
<?php include("sidebar.php"); ?>
    <div class="container-fluid">
        <div class="row mb-0">
             <div class="col-sm-12">
                <h3 class="page-title">Shift and Schedules</h3>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="l.html">Time and Attendance</a></li>
                    <li class="breadcrumb-item active">Shift and Schedules</li>
                </ul>
            </div>
        </div>
            <div class="row">
                <div class="col-sm-3">
                    <div class="card text-dark bg-light">
                        <div class="card-body">
                            <h5 class="card-title">AM Shift</h5>
                            <p class="card-text">total of am</p>
                        </div>
                    </div>
                </div> 
                <div class="col-sm-3">
                    <div class="card text-dark bg-light">
                        <div class="card-body">
                            <h5 class="card-title">PM shift</h5>
                            <p class="card-text">total of Am</p>
                        </div>
                    </div>
                </div>  
