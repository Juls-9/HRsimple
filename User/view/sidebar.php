...
<div id="main">
  ...
  <ul class="flex">
    <button class="openbtn" onclick="openNav()">☰</button>
      ...
      <?php if(!isset($_SESSION["user_idsd"])){ ?>
      <li style="margin-left:auto;"><i class="fa-solid fa-circle-user fa-2xl" style="color: #081935;"></i> Profile</li>
      <?php }else{?>
        <li style="margin-left:auto;"><i class="fa-solid fa-circle-user fa-2xl" style="color: #081935;"></i> <a href="logout.php">Log out <?php echo $_SESSION["user_idsd"] ?></a></li>
        <?php } ?>
  </ul>
  <hr>
